/*
 The earlier version debouncing was set on CHANGE, so it was missing the second change of level shifting, that's why state was stuck to TRUE and loop continued.
 So here i am implementing standard debouncing code of arduino.
*/
...
//      Serial.println(counter);
      if(counter > 3000){
        ...
        counter = 0;
//        isPRESSED = false;//button state made UNPRESSED to make sure while loop does not go on if MCU missed the state change
        state = 0;
      }
    }
